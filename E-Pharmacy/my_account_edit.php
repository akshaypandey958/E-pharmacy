...
//    $email = $_POST['email'];
    ...
    $query = "UPDATE user_mst SET f_name='{$fname}',m_name='{$mname}',l_name='{$lname}',gender='{$gender}',address='{$add}' WHERE user_id='{$uid}'";
                    ...
                    <div class="address_form_agile">
                        <form method="post" id="form">
                            <div class="creditly-wrapper wthree, w3_agileits_wrapper">
                                <div>
                                    <h4 style='font-size:22px;'>Personal Information</h4>
                                    <div><label>First Name</label>
                                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" name="fname" style='width: 40%;font-size: 15px;letter-spacing: 1px;padding: 7px 10px;margin-bottom: 20px;outline: none;border: none;box-shadow: 0px 0px 3px 0px rgb(0 0 0 / 31%);' value="<?php echo $userdata['f_name'] ?>" onkeyup="Validatestring(this)">
                                        <br><label>Middle Name</label>
                                        &nbsp;&nbsp;&nbsp;&nbsp;<input type="text" name="mname" style='width: 40%;font-size: 15px;letter-spacing: 1px;padding: 7px 10px;margin-bottom: 20px;outline: none;border: none;box-shadow: 0px 0px 3px 0px rgb(0 0 0 / 31%);' value="<?php echo $userdata['m_name'] ?>" onkeyup="Validatestring(this)">
                                        <br><label>Last Name</label>
                                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" name="lname" style='width: 40%;font-size: 15px;letter-spacing: 1px;padding: 7px 10px;margin-bottom: 20px;outline: none;border: none;box-shadow: 0px 0px 3px 0px rgb(0 0 0 / 31%);' value="<?php echo $userdata['l_name'] ?>" onkeyup="Validatestring(this)">
                                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br>
                                ...
                                <div>
                                       ...
                                       <br><br><h4 style="font-size:22px;">Address Details</h4>
                                        ...
                                        <input type="text" name="loc" required placeholder="Home No./Flat No./Apartment Name" style="width: 50%;font-size: 15px;letter-spacing: 1px;padding: 7px 10px;margin-bottom: 20px;outline: none;border: none;box-shadow: 0px 0px 3px 0px rgb(0 0 0 / 31%);"> 
