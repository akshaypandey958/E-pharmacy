    ...
    <body>
        <?php include './pharmacy-page-part/header.php' ?>
            <div class="container" style="padding-top: 15px;padding-left: 0px;padding-bottom: 150px">
                <h3 class="" style="color: black;font-size: 25px;text-align: center;margin-bottom: 30px;">MY ORDERS
                </h3>
                    ...
                    <div class="table-responsive">
                        <table style="width:100%;border : 1px solid #cdcdcd" class="timetable_sub">
                            <thead style="background: #CACACA;font-size:20px;">
                             ...
                             <tbody>
            <?php
                $query = mysqli_query($connect,"SELECT * FROM order_mst WHERE by_id = '{$user_id}' order by order_date_time DESC");
                $i=0;
            ...
            ?>
                		...
                		<tr>
                                    ...
                                    <td><?php echo "<a href='my_order_details.php?oid={$result['ord_id']}'>Details </a>"?></td>
                                </tr>
