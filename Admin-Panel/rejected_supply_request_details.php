...
if (isset($_POST['approved'])) {
        $queryr = mysqli_query($connect, "UPDATE order_mst SET type='Ord' WHERE ord_id='{$oid}'") or die(mysqli_query($connect));
         if ($queryr) {
...
if (isset($_POST['reject'])) {
        $queryr = mysqli_query($connect, "UPDATE order_mst SET type='Rej' WHERE ord_id='{$oid}' AND type='Req'") or die(mysqli_query($connect));
         if ($queryr) {
            echo "<script>alert('Request Rejected succesfully');
    window.location.href = 'new_supply_request.php';
    </script>";
                ...
                <div class="main-page">
                    <div class="tables">
                        ...
                        <div class="panel-body widget-shadow">
                            <h4>Rejected Supply Request Details</h4>
                            <form method="POST">
                                <table class="table">
                                    <tbody>
<?php
...
?>
                                    <b><p style="color:red;font-size: 20px">Rejected</p><br></b>
                                        <tr>
                                            <th>ID</th>
