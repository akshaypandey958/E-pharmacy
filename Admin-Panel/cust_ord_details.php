                                    ...
                                    $sql = "SELECT
                                        ...
                                        FROM
                                            ...
                                            INNER JOIN `order_description` 
                                                ON (`order_mst`.`ord_id` = `order_description`.`order_id`) WHERE order_mst.by_id = $userid;";
                                     $query = mysqli_query($connect,$sql);
                                     while($row = mysqli_fetch_assoc($query))
                                     {
                                           $q = mysqli_query($connect,"SELECT pro_name FROM product_mst WHERE pro_id = '{$row['pro_id']}'");
