                    ...
                    <div class="tables">
                        ...
                        <div class="panel-body widget-shadow">
                            ...
                            <table id="table2" class="table">
                                ...
                                <tbody>
                                    <?php
                                     $query = mysqli_query($connect, "select * from user_mst where usertype_id=2 and is_verified='yes'");
                while($row=mysqli_fetch_array($query))
                {
                echo "<tr>";
                echo "<td>{$row[0]}</td>";
                echo "<td>{$row[2]}</td>";
                echo "<td>{$row[6]}<br>{$row[7]}</td>";
                echo "<td>{$row[10]}</td>";
                echo "<td><a href='{$row[11]}'><img style='width:70px;height:70px' src='{$row[11]}'></img></a></td>";
                echo "<td>{$row[9]}</td>";
                 echo "<td>{$row[12]}</td>";
                echo "<td><a href='supplier.php?bid={$row[0]}'><img src='images/block-user.png' style='width:19px;'> Block</a> | <a href='supplier.php?uid={$row[0]}'><img src='images/unlock.png' style='width:19px;'> UnBlock</a></td>";
                }
             ?>
                                </tbody>
                            </table>
