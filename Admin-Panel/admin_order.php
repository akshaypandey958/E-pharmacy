                ...
                <div class="main-page">
                    <div class="tables">
                        ...
                        <div class="panel-body widget-shadow">
                            <h4>Admin Order (Supplier Request)</h4>
                            <table id="table2" class="table">
                                ...
                                <tbody>
                                    <?php
                                    $supplier=mysqli_query($connect,"SELECT * FROM user_mst WHERE usertype_id=2");
...
{
     echo "<option value='admin_order.php?id={$row['ord_id']}'>Pending</option>"; 
}
 else {
     echo "<option value='admin_order.php?id={$row['ord_id']}'>Delivered</option>"; 
}
