    ...
    <body class="cbp-spmenu-push">
        <div class="main-content">
                    ...
                    <div class="tables">
                        ...
                        <div class="panel-body widget-shadow">
                            ...
                            <table id="table2" class="table">
                                ...
                                <tbody>
                                      <?php
                                     $query = mysqli_query($connect, "select * from user_mst where usertype_id=2 and is_verified='no'");
            ...
            <tr>
                ...
                <td><?php echo "<a href='supplier_verifi_details.php?uid={$row[0]}'>Review </a>"?></td>
            </tr>
            <?php
                }
             ?>
