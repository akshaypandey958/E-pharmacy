    ...
    <body>
      ...
      <div class="agileinfo-ads-display col-md-12 w3l-rightpro">
          <center> <div style=" box-shadow: 0px 0px 15px 0px #D6D6D6;padding: 100px 20px;margin-bottom:80px;margin-top:70px;width:50% ">
                  <h3 style="letter-spacing: 2px;">Your Request Send Successfully !!</h3><br>
          ...
          <div style=" ">
              <a style="font-size: 14px;letter-spacing: 1px;color: black;float: right; margin: 20px 0;margin-right:100px" href="request_details.php"><b>VIEW REQUEST</b></a>
        </div>
        </div>
