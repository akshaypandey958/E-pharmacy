...
<!DOCTYPE html>
    ...
    <style>
        ...
        <body>
           ...
           <div class="ads-grid"  style="padding-top: 15px;padding-left: 0px;padding-bottom: 10px">
            <div class="container">
                        ...
                        <form action="E-Pharmacy.php" method="post" id="form">
                         ...
                         $query = mysqli_query($connect, "select* from user_mst where user_id=$user_id") or die (mysqli_error($connect));
                            ...
                            { ?>
                                ...
                                <div>
                                    <h4 style='font-size:22px;'>Business Information<?php echo "<a href='my_account_edit.php?uid={$row[0]}'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Edit</a>";?></h4>
                                    <div><label>Supplier Name</label>
                                        &nbsp;&nbsp;&nbsp;<input readonly="text" value=<?php echo "{$row[2]}" ?> style='width: 29%;font-size: 15px;letter-spacing: 1px;padding: 7px 10px;margin-bottom: 20px;outline: none;border: none;box-shadow: 0px 0px 3px 0px rgb(0 0 0 / 31%);'>
                                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<label>GST Number</label>
                                        &nbsp;&nbsp;&nbsp;<input readonly="text" style='width: 40%;font-size: 15px;letter-spacing: 1px;padding: 7px 10px;margin-bottom: 20px;outline: none;border: none;box-shadow: 0px 0px 3px 0px rgb(0 0 0 / 31%);' value=<?php echo "{$row[10]}" ?>>
                                       </div>
                                    ...
                                    <div><label>Mobile Number</label>
                                        ...
                                        &nbsp;&nbsp;&nbsp;<input readonly="text" value=<?php echo "{$row[7]}" ?> style='width: 38%;font-size: 15px;letter-spacing: 1px;padding: 7px 10px;margin-bottom: 20px;outline: none;border: none;box-shadow: 0px 0px 3px 0px rgb(0 0 0 / 31%);'>
                                    </div>
                            </div>
                                    <br><br><h4 style='font-size:22px;'>Address</h4>
