...
<body>
    ...
    <div class="ads-grid" style="padding-bottom:155px">
        <div class="container">
					...
					<div class="col-xs-6 footer-grids">
						<ul>
							<li>
								...
								<a href="mailto:example@mail.com">support@epharmacy.com</a>
                                                                 <br><br><i class="fa fa-envelope-o"></i>
								<a href="mailto:example@mail.com">support.supplier@epharmacy.com</a>
							</li>
                                                        <li>	
						</ul>
					</div>
