...
{
            $price=$_POST["price"];
            $check = mysqli_query($connect, "UPDATE order_description SET price='{$price}' WHERE order_id='{$oid}'");
            if($check)
            {
                 echo "<script>alert('Information Send Successfully !!!');
            ...
            <?php }?>
               ...
               <form method="post" enctype="multipart/form-data" id="form">
                    <div class="creditly-wrapper wthree, w3_agileits_wrapper">
                        <div>
                            <div><br><label>Enter Product Price</label>
                            ...
                            <button class="submit check_out" name="submit">Send Information</button>
                        </div>
                    </div>
                </form>
